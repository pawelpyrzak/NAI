    ...
    fetch('/api/notifications/all/')
        ...
        .then(data => {
            ...
            data.forEach(notification => {
                ...
                const deleteButton = createButtonWithImage("/static/images/x.svg", 'X');
                ...
                if (notification.type == "reminder") {
                    const infoButton = createInfoButton(notification);
...
function createButtonWithImage(src, alt) {
...
function createInfoButton(notificationId) {
    ...
    button.appendChild(img);  // Dodajemy obrazek do linku
    return button;
}
