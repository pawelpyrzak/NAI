...
# Funkcja do tworzenia zadania w Jira
...
def main():
    command = "Utwórz zadanie: title:Nowe zadanie3, description:Opis zadania, start_date:2024-12-04, due_date:2024-12-10, priority:High"
