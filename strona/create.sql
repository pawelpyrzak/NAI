...
create table "user" (id bigint generated by default as identity, email varchar(255) not null, first_name varchar(255) not null, last_name varchar(255) not null, password varchar(255) not null, primary key (id));
...
create table invitation_token (expiry_date date, "group_id" bigint, id bigint generated by default as identity, token varchar(32), primary key (id));
...
create table users_role (role_id bigint not null, user_id bigint not null, primary key (role_id, user_id));
